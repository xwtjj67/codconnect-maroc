...
import { LayoutDashboard, Package, ShoppingCart, Users, GraduationCap, LogOut, Menu, X, Sparkles } from "lucide-react";
...
const sidebarItems = [
  ...
  { title: "الخدمات", url: "/dashboard/services", icon: Sparkles },
];
