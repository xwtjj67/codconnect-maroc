    ...
    <MerchantLayout>
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard title="المنتجات" value={stats.products} icon={<Package className="h-6 w-6" />} tooltip="عدد المنتجات" />
