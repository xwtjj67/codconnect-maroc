          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">الشيت</TableHead>
                  ...
                  <TableRow key={log.id}>
                    ...
                    <TableCell>
                      <Badge variant="secondary">
                        {log.user_role === "affiliate" ? "مسوق" : log.user_role === "product_owner" ? "مورد" : log.user_role || "—"}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <Badge variant="outline">Sheet {log.sheet_index + 1}</Badge>
                    </TableCell>
                    <TableCell>
                      {log.success ? (
                        <span className="flex items-center gap-1 text-green-600"><CheckCircle2 className="h-4 w-4" /> نجح</span>
                      ) : (
                        <span className="flex items-center gap-1 text-destructive"><XCircle className="h-4 w-4" /> فشل</span>
                      )}
                    </TableCell>
